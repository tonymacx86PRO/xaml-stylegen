...
def arr2csv(arr, file):
    ...
    BorderThickness, 
    Button.IsFocused, 
    BorderThickness (Button.IsFocused), 
    BorderBrush (Button.IsFocused) (r), 
    BorderBrush (Button.IsFocused) (g), 
    BorderBrush (Button.IsFocused) (b), 
    Button.IsEnabled, 
    Background (Button.IsEnabled) (r), 
    Background (Button.IsEnabled) (g), 
    Background (Button.IsEnabled) (b), 
    BorderBrush (Button.IsEnabled) (r), 
    BorderBrush (Button.IsEnabled) (g), 
    BorderBrush (Button.IsEnabled) (b), 
    Rounding, 
    CornerRadius (Rounding), 
    Button.MouseEnter, 
    To (Button.MouseEnter) (r), 
    To (Button.MouseEnter) (g), 
    To (Button.MouseEnter) (b), 
    Duration (seconds - Button.MouseEnter), 
    Button.MouseLeave, 
    To (Button.MouseLeave) (r), 
    To (Button.MouseLeave) (g), 
    To (Button.MouseLeave) (b), 
    Duration (seconds - Button.MouseLeave)
    '''.replace("\n", " "),
    comments='')
